...
/*
	Legge tutti i feeds indicizzati in un paio di OPML (di cui uno e' quello di lugmap.it), estrae le news che parlano di Linux Day e genera un altro RSS
*/

include_once ('/usr/share/php/simplepie/simplepie.inc');

$lugs = '/var/www/lugmap/LugMap/lugs.opml';
